  ...
  tools: [
    ...
    },
    {
      ...
      inputSchema: {
        type: 'object',
        properties: {
          diagnosis_code: { type: 'string', description: 'ICD-10 diagnosis code (e.g. "K80.20")' },
          procedure_code: {
            type: 'string',
    ...
    },
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          city: { type: 'string', description: 'Hospital city (e.g. "Mumbai", "Pune", "Jaipur")' },
          hospital_tier: {
            type: 'string',
            enum: ['A', 'B', 'C'],
  ...
  try {
    switch (name) {
      case 'lookup_icd10':
        return {
          content: [
            { type: 'text', text: JSON.stringify(await lookupIcd10(args!['diagnosis'] as string)) },
          ],
        };
